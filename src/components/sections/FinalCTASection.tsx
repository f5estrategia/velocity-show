    ...
    <section className="py-24 md:py-32 bg-gradient-to-b from-secondary/30 to-background relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 md:px-6 relative z-10">
        <div className="max-w-3xl mx-auto text-center space-y-6 md:space-y-8">
          <h2 className="text-2xl md:text-4xl lg:text-5xl font-semibold leading-tight tracking-tight">
            Quanto mais tempo você vai ficar
            <span className="block mt-2 gradient-text">reclamando?</span>
          </h2>

          <div className="text-sm md:text-base text-muted-foreground space-y-3 max-w-xl mx-auto px-4">
            <p>
          ...
          <div className="inline-flex items-center gap-2 bg-gold/5 border border-gold/20 px-4 md:px-5 py-2 md:py-2.5 rounded-full">
            <span className="text-gold text-[10px] md:text-xs font-medium">
